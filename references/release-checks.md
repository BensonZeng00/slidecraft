...
7. Source fidelity: include a selected image with an apparently illogical curved arrow, secondary caption and textured decoration. With only “reproduce it” or “yes”, preserve all of them. Ensure changed text, straightened/rerouted arrows, deleted decorations, changed proportions and new reading labels fail the source/plan CLI check. Test exact scoped user changes separately. Real source-to-render comparison must be recorded; synthetic gate tests cannot prove visual reproduction.
